...
class AugMixDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, preprocess, all_ops=False, mixture_width=3,
                mixture_depth=-1, aug_severity=3, no_jsd=False, image_size=256):
        ...
        self.no_jsd = no_jsd
        self.aug = functools.partial(aug_func, all_ops=all_ops, mixture_width=mixture_width, mixture_depth=mixture_depth, aug_severity=aug_severity)
